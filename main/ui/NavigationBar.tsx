    ...
    <div className="w-full md:min-h-screen md:border border-[#c6c6c6] flex flex-row md:flex-col justify-between md:justify-start items-start md:items-center px-2 md:px-5 py-2 md:py-5 gap-6">
      <div className="flex flex-col gap-[1px] w-full">
        <div className="flex justify-start items-center gap-4">
          ...
          <span className="md:text-4xl text-lg uppercase font-[600]">
            moniswap
          </span>
        </div>
      ...
      <button className="w-full flex justify-start items-center gap-3 bg-[#e7e2b6] capitalize px-2 py-2 rounded-[5px] btn border-none">
        <LuWallet size={27} />
        <span className="capitalize font-[400] md:text-xl text-center">
          connect wallet
        </span>
      </button>
      ...
      <div className="flex flex-col justify-start items-start gap-4 w-full">
        <span className="text-sm md:text-lg font-[400] text-[#9a9888]">
          Moniswap v1.0.0
        </span>
        <div className="flex justify-start items-start gap-2 w-full">
          ...
          <a
            href="#"
            className="btn btn-ghost btn-xs text-center flex justify-center items-center"
          >
