    ...
    <Card data-aos="fade-up" className="px-[32px] relative">
      ...
      <div className="flex flex-col xl:flex-row justify-between pt-[11px] items-end border-none xl:border-t border-black-12">
        <div className="flex flex-col w-full  xl:flex-row items-start xl:items-center gap-x-2">
          ...
          <Button theme="dark" className="xl:w-auto mt-[17px] w-full !transition-all !duration-300">
            ends in a day
          </Button>
        </div>
        ...
        <div className="xl:flex-row xl:py-0 py-[18px] items-start w-full xl:w-auto flex-col xl:gap gap-5 flex gap-3">
          <p className="text-[13px] text-black-4  font-medium leading-[15.73px]">
            Total Fees: <span className="text-[13px]  text-white font-medium leading-[15.73px]">~$1,629,655.42</span>{" "}
          </p>
          <p className="text-[13px] text-black-4  font-medium leading-[15.73px]">
            Total Incentives:{" "}
            <span className="text-[13px]  text-white font-medium leading-[15.73px]">~$604,095.07</span>{" "}
          </p>
          <p className="text-[13px] text-black-4  font-medium leading-[15.73px]">
            New Emissions: <span className="text-[13px]  text-white font-medium leading-[15.73px]">13,140,559.9 </span>{" "}
          </p>
        </div>
      </div>
      ...
      <Image src="/images/bea.png" alt="bea" width={64} height={56} className="absolute top-[7px] right-[23px]" />
    </Card>
  </div>
);
