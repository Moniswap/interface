  ...
  return (
    <Card data-aos="fade-up" className="w-full xl:w-[60%]">
      ...
      <p className="text-[13px]  font-normal leading-[15.73px] mt-[20px] text-[#CFCFCF]">
        0.01238  <span className="text-[#7D7D7D]">veMONI</span> voting power granted
      </p>
      <div className="border-t pt-[22px] mt-[35px] border-t-[#2B2B2B] ">
        <div className="px-[18px] pb-[35px] py-[12px] bg-[#141414]  rounded-[12px]">
          ...
          <p className="text-[13px] mt-[22px] text-[#7D7D7D]  font-normal leading-[15.73px]">
            When activated, it sets the lock to maximum unlock time, until disabled. Once disabled, the regular vesting
            unlock time will apply. Maximum unlock time gives a 1-to-1 voting power to the amount of locked tokens.
          </p>
        </div>
      </div>
      ...
      <div className="pt-[15px] border-t mt-[21px] border-[#2B2B2B]">
        <p className=" text-[15.1px] text-white  font-medium leading-[18.27px] ">
          Extending to 4 years for 34.88  <span className="text-[#7D7D7D]">veMONI</span> voting power.
        </p>
        <Slider
        ...
        <Notifaction
          ...
          title={
            <p>
              ...
              These actions will increase your voting power. The maximum lock time is 4 years!
            </p>
          }
        />
      </div>
