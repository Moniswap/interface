...
export const Locks = ({ locks }: Props) => {
  return (
    <div className="mt-[96px]">
      ...
      <div data-aos="fade-up" className="w-full py-[53px] px-[21px] xl:px-[34px] bg-[#1E1E1E] rounded-xl">
        {!locks ? (
          ...
          <div className="flex flex-col xl:flex-row justify-between">
            <div className="flex gap-x-[21px]">
              ...
              >
                <Image src={"/images/moni.png"} width={35} height={35} alt="logo" className="rounded-full" />
              </div>
