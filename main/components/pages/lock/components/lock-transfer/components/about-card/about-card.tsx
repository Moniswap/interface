...
export const AboutCard = ({ setStep }: Props) => (
  <Card data-aos="fade-up" className="bg-[#FABD61] text-white w-full xl:w-[40%] relative">
    ...
    <p className="text-[15.1px] mt-[21px]  font-normal leading-[18.27px]">
      Transferring a lock will also transfer any rewards and rebases! Before continuing, please make sure you have 
    ...
    <Image className="absolute top-[7px] right-[8px]" src="/images/bea.png" width={64} height={54} alt="logo" />
  </Card>
);
