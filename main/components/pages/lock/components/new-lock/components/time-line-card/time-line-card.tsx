  ...
  const TIMELINES = [
    {
      ...
      finishLabel: <p className="text-[13px]  font-normal leading-[15.73px] text-[#CFCFCF]">Depositing 35 MONI</p>,
    ...
    },
    {
      ...
      finishLabel: <p className="font-normal  text-[13px] leading-[15px] text-white-1">Minimum received 27.08 USDC</p>,
  ...
  return (
    <Card data-aos="fade-up" className="w-full xl:w-[40%]">
      <div className="flex w-full justify-between">
        <p className="font-medium  text-[15px] leadin-[18px] text-white">Swap</p>
