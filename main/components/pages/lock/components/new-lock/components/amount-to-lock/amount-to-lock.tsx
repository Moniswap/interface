"use client";
import { Avatar, Button, Card, Notifaction, SelectCoin, SwapperCoin } from "@/components/common";
...
export const AmountToLockCard = () => {
  ...
  return (
    <Card data-aos="fade-up" className="w-full xl:w-[60%]">
      ...
      <Slider className="mt-[20px]" onValueChange={e => setProcent(e)} defaultValue={procent} max={100} step={1} />
