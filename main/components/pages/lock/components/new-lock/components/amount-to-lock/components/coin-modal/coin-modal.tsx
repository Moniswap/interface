  ...
  return (
    <Modal open={open} close={close}>
      ...
      <div className="flex px-4 border-b border-b-black-9 justify-between w-full pt-[17px] pb-[19px] ">
        <p className="text-[13px] leading-[15px] font-normal  text-black-4">85 Tokens</p>
        <p className="text-[13px] leading-[15px] font-normal  text-black-4">Balance</p>
      </div>
          ...
          >
            ...
            <div className="w-full">
              <div className="flex w-full justify-between">
                ...
                <h2 className="font-bold text-[15px] leadin-[18px]  text-white">{coin.count}</h2>
              </div>
