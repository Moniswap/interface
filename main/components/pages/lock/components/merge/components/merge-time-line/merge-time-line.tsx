  ...
  const TIMELINES = [
    {
      ...
      finishLabel: (
        <p className="text-[13px]  font-normal leading-[15.73px] text-[#CFCFCF]">Merging Lock 14578 into Lock 12337</p>
      ),
    ...
    },
    {
      ...
      finishLabel: <p className="font-normal  mt-[5] text-[13px] leading-[15px] text-white-1">Lock 14578 selected.</p>,
  ...
  return (
    <Card data-aos="fade-up" className="w-full xl:w-[40%]">
      <div className="flex w-full justify-between">
        <p className="font-medium  text-[15px] leadin-[18px] text-white">Merge</p>
