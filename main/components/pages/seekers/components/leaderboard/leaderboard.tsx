  ...
  <div className="container mt-[28px] mb-[120px]">
    ...
    >
      <div className="flex flex-col xl:flex-row items-start xl:items-center justify-between">
        <h2 className="text-white text-[18.863px] xl:text-[25px]  font-medium leading-[normal]">The Leaderboard</h2>
      ...
      <Table>
        ...
        <TableBody>
          ...
          <TableRow data-aos="fade-up" className="border-none">
            <TableCell className="text-center text-[#CFCFCF] text-[15px]  font-medium leading-[normal]" colSpan={4}>
              13,951 other participants
            </TableCell>
          </TableRow>
          {TABLEDATA.slice(0, 5).map((item, index) => (
            <TableRow key={index} className=" border-none hover:bg-[#FF993C] overflow-hidden">
              <TableCell className="text-[#CFCFCF] rounded-l-[10px] text-[15px]  font-medium leading-[normal]">
                {(index + 1) * 100}
              </TableCell>
              <TableCell className="text-[#CFCFCF]  text-[15px]  font-medium leading-[normal]">{item.id}</TableCell>
              <TableCell className="text-[#CFCFCF] text-[15px]  font-medium leading-[normal]">{item.count}</TableCell>
