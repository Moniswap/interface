    ...
    <div className=" container px-5 lg:px-8 xl:px-0 mt-[22px] xl:mt-[31px]">
      ...
      >
        ...
        <p className="text-[#CFCFCF] text-[10px] xl:text-[13px]  w-[80%]   font-normal leading-[normal]">
          You've already referred 0 new users, of these 0 new users are counted to your referral multiple. After your
          next referral, your new score multiplier will be 2x and your total points will increase to 400!
        </p>
        ...
        <div data-aos="fade-up" className="grid mt-[55px] gap-x-2.5 gap-y-[5px] grid-cols-1 xl:grid-cols-3">
