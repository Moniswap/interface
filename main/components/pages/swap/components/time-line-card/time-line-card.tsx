...
export const TimeLineCard = () => {
  const TIMELINES = [
    {
      label: "Start by selecting the token to Swap from and the amount you want to exchange",
      finishLabel: (
        <div>
    ...
    },
    {
      label: "Start by selecting the token to Swap from and the amount you want to exchange",
      finishLabel: (
        <p className="font-normal  text-[13px] leading-[15px] text-white-1">1.0% slippage applied... Adjust</p>
      ),
