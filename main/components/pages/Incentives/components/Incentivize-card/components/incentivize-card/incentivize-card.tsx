...
export const IncentivezeCard = () => {
  const timeline: TimeLineType[] = [
    {
      ...
      finishLabel: (
        <p className="text-[13px] mt-1 text-white-1  font-normal leading-[15.73px]">Gauge for vAMM-WETH/MONI found</p>
      ),
    ...
    },
    {
      ...
      finishLabel: (
        <p className="text-[13px]  mt-1 text-white-1  font-normal leading-[15.73px]">MONI can be used for incentives</p>
      )
    },
    {
      ...
      finishLabel: (
        <>
          <p className="text-[13px] text-white-1  font-normal leading-[15.73px]">Allowance not granted for MONI</p>
          <Button
    ...
    {
      label: (
        <p className="mt-2 text-[13px] text-white-1  font-normal leading-[15.73px]">Waiting for pending actions...</p>
      ),
      icon: <PenddingIcon />,
      finishLabel: (
        <p className="mt-2 text-[13px] text-white-1  font-normal leading-[15.73px]">Waiting for pending actions...</p>
  ...
  return (
    <Card data-aos="fade-up">
      <h3 className="text-[15.1px]  font-medium leading-[18.27px] text-white">Incentivize</h3>
      <p className="text-[13px] mt-[35px] mb-[52px] text-white-1  font-normal leading-[15.73px] ">
        Voting and adding incentives for this epoch ends in a day and there will be{" "}
        <span className="text-[13px]  font-bold text-white leading-[15.73px]">0.0</span> distributed to all liquidity
        providers. By providing an incentive, you draw more liquidity providers to this pool.
      </p>
      <TimeLine timeLines={timeline} active={3} />
      <Button className="text-[15px] w-full py-[18px] mt-10  font-medium leading-[18.15px]" theme="dark-orange">
        Add Incentives
      </Button>
    </Card>
  );
