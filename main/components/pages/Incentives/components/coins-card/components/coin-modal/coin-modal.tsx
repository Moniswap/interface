  ...
  return (
    <Modal open={open} close={close}>
      ...
      <div className="flex px-4 border-b border-b-black-9 justify-between w-full pt-[17px] pb-[19px] ">
        <p className="text-[13px] leading-[15px] font-normal  text-black-4">619 Liquidity Pools</p>
        <p className="text-[13px] leading-[15px] font-normal  text-black-4">Has Deposit / Stake</p>
      </div>
        ...
        {COINS.map((coin, index) => (
          ...
          >
            <div className="flex relative pl-6">
              ...
              <Avatar src={coin.image} name={coin.title} size="xl" className="absolute right-7 z-10" />
            </div>
            <div className="w-full">
              <div className="flex w-full justify-between">
                <h2 className="font-bold text-[15px] leadin-[18px]  text-white">{coin.title}</h2>
                <h2 className="font-bold text-[15px] leadin-[18px]  text-white">---</h2>
              </div>
              <div className="flex w-full mt-[11px] justify-between">
                <p className="text-black-4  font-medium text-[13px]">{coin.subtitle}</p>
                <p className="text-black-4  font-medium text-[13px]">{coin.price}</p>
              </div>
            </div>
          </div>
        ))}
