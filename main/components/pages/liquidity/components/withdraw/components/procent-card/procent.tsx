  ...
  return (
    <Card data-aos="fade-up" className="w-full xl:w-[60%]">
      ...
      <div className="text-black-4 mt-[15px] mb-[11px] flex w-full justify-between">
        ...
        <p className=" text-[13px]  font-normal leading-[15.73px]">Withdrawing</p>
      </div>
      ...
      <p className="text-[15.1px]  font-medium leading-[18.27px] text-black-4">Stake {procent[0]}%</p>
      <div className="mt-5">
        <Slider className="" onValueChange={e => setProcent(e)} defaultValue={procent} max={100} step={1} />
      </div>
