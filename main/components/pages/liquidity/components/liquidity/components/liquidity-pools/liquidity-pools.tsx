  ...
  return (
    <section>
      <div className="container pt-[80px] pb-8 px-5 lg:px-8 xl:px-0">
        <h1 data-aos="fade-up" className="text-[25px]  leading-[30px] text-white">
          Liquidity Pools
        </h1>
        <div className="flex flex-col xl:flex-row mt-[30px] mb-[24px]">
          <div data-aos="fade-up" className="max-w-full hide_scroll overflow-x-auto xl:w-[80%]">
            <TabFilter
              name="status"
              value={tabValue}
          ...
          <div data-aos="fade-up" className="w-full mt-[20px] xl:mt-0  xl:w-[20%]">
            <Input type="search" placeholder="Symbol or Address" className="w-full" />
          </div>
        </div>
        ...
        <Table data-aos="fade-up">
          <TableHeader className="!rounded-[12.8px] bg-black-3 ">
            ...
            <TableHead className="text-end w-auto xl:!w-[211px] text-[13px] font-medium leading-[15px] ">APR</TableHead>
            ...
            <div data-aos="fade-up" className="pb-[31px]" key={index}>
              <div className="flex mb-[14px] border-b border-b-black-11 items-center gap-[13px]">
                <div className="relative flex mr-4">
                  <Avatar src="/images/cat.png" name="MONI" className="w-[29px] h-[29px]" />
                  <Avatar src="/images/cat.png" name="MONI" className="w-[29px] h-[29px] absolute left-4" />
                </div>
                <div>
                  <h2 className="font-medium  text-[15px] leading-[18px] text-white">vAMM-WETH/MONI</h2>
              ...
              <div className="border-b mb-[18px]  border-b-black-11 mt-[8px]">
                <p className=" text-black-4 text-[11.82px]  font-normal leading-[14.31px]">
                  TVL{" "}
                  <span className=" text-white-2 text-[11.82px]  font-normal leading-[14.31px]">~$51,233,453.32</span>
                </p>
              ...
              <div className="border-b border-b-black-11">
                <p className="text-[11.82px] text-black-4  font-normal leading-[14.31px]">Volume</p>
                ...
                <p className="text-[11.82px] my-[8px] text-white-1  font-normal leading-[14.31px] ">
                  2,425.62 <span className="text-[11.82px] text-black-4  font-normal leading-[14.31px]">WETH</span>
                </p>
                <p className="text-[11.82px] mb-[12px] text-white-1  font-normal leading-[14.31px] ">
                  9,683,215.9 <span className="text-[11.82px] text-black-4  font-normal leading-[14.31px]">USDC</span>
                </p>
              </div>
              <div
              ...
              "
              >
                <p className="text-[11.82px] text-black-4  font-normal leading-[14.31px]">Fees</p>
                <p className="text-[11.82px] mt-[13px]  text-white-1  font-normal leading-[14.31px] ">
                  ~$19,134,626.38
                </p>
                <p className="text-[11.82px] my-[8px] text-white-1  font-normal leading-[14.31px] ">
              ...
              "
              >
                <p className="text-[11.82px] text-black-4  font-normal leading-[14.31px]">Pool Balance</p>
                <p className="text-[11.82px] mt-[13px]  text-white-1  font-normal leading-[14.31px] ">
                  ~$19,134,626.38
                </p>
                <p className="text-[11.82px] my-[8px] text-white-1  font-normal leading-[14.31px] ">
