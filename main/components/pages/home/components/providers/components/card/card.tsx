...
export const Card = ({ proviter }: Props) => (
  ...
  >
    <div className="w-full px-[26px] pt-[29px] pb-[28px]">
      ...
      <p className="mt-5 text-white-1 font-normal text-[15px] leading-[18px] ">{proviter.subtitle}</p>
    </div>
    <Image
      src="/images/bea.png"
      width={40}
    ...
    />
    <Image width={284} height={242} className="w-full h-auto" src={proviter.image} alt={proviter.title} />
  </div>
);
