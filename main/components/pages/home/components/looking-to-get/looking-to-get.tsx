  ...
  <section className="w-full bg-[url('/images/bg.svg')] h-screen bg-no-repeat	bg-center my-20">
    <div className="flex w-full mx-auto items-center justify-center flex-col">
      ...
      <div className="flex items-center h-[calc(100vh-100px)] flex-col  justify-center w-full">
        <Image src="/images/chain.png" width={90} height={30} alt="chain" className="my-5" data-aos="zoom-in-up" />
        <h1 data-aos="zoom-in-up" className="text-white text-[25px] xl:text-[25px]  text-center">
          Looking to get{" "}
        </h1>
        <h1 data-aos="zoom-in-up" className="text-white text-[27px] xl:text-[40px]  text-center">
          Started on Moniswap?
        </h1>
        <Link
          href="/swap"
