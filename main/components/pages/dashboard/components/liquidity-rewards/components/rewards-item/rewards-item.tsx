    ...
    <div className="flex flex-col xl:flex-row justify-between">
      <div className="flex pl-[20px] items-center gap-x-[15px]">
        <div className="relative">
          <Avatar src="/images/cat.png" className="w-[32px] h-[32px]" name="coin" />
          <Avatar src="/images/cat.png" className="w-[32px] h-[32px] absolute top-0 right-5" name="coin" />
        </div>
        <div>
          <h3 className="text-white text-[15px]  font-medium leading-[normal]">vAMM-WETH/DOG</h3>
      ...
      <div className="border-t border-[#33332D] pb-[10px] xl:pb-0 pt-[10px] xl:pt-0 xl:border-none ">
        <p className="text-[#7D7D7D] text-left xl:text-right text-[13px]  font-normal leading-[normal]">Emissions</p>
        <p className=" mt-[21px] text-white text-left xl:text-right text-[13px]  font-normal leading-[normal]">
      ...
      <div className="flex flex-col items xl:items-end border-t border-t-[#33332D] xl:border-none pt-[16px] xl:pt-0">
        <p className="text-[#7D7D7D] text-left xl:text-right text-[13px]  font-normal leading-[normal]">Trading Fees</p>
        <p className="mt-[21px] text-white text-left xl:text-right text-[13px]  font-normal leading-[normal]">
