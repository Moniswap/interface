  ...
  <TableRow data-aos="fade-up" className="border-b-black">
      ...
      <div className="flex">
        <div className="flex gap-x-[15px]">
          <div className="relative flex mr-4">
            ...
            <Avatar src="/images/cat.pang" name="MONI" className="w-[32px] h-[32px] absolute left-4" />
          </div>
    ...
    <TableCell className="text-right">
      <Card>
        ...
        <p className="text-[13px] text-[#7D7D7D] my-4  font-normal leading-[15.73px]">327,589.36 USDC</p>
        <p className="text-[13px] text-[#7D7D7D]  font-normal leading-[15.73px]">694,044.38 MONI</p>
      </Card>
    </TableCell>
    <TableCell className="text-right">
      <Card>
    ...
    <TableCell className="text-right">
      <Card>
        ...
        <p className="text-[13px] my-4  text-[#7D7D7D] font-normal leading-[15.73px]">327,589.36 USDC</p>
        <p className="text-[13px]  text-[#7D7D7D] font-normal leading-[15.73px]">694,044.38 MONI</p>
      </Card>
    </TableCell>
