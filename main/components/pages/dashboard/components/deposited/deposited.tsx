            ...
            <>
              ...
              <div className="w-full mt-[15px] rounded-xl bg-[#1E1E1E] py-[12px] px-[12px] xl:hidden">
                {new Array(10).fill(1).map((_, index) => (
                  <div data-aos="fade-up" className="border-b pb-[18px] border-b-black" key={index}>
                    <div className="flex pt-[14px] gap-[25px] mb-[26px] items-center">
                      <div className="flex relative  ">
                        <Avatar src="/images/cat.png" name="avatr" className="w-[29px] h-[29px]" />
                        <Avatar
                          src="/images/cat.png"
                          name="avatr"
                      ...
                      <div>
                        <h2 className="text-[13.64px]  font-medium leading-[16.51px] text-white">vAMM-WETH/MONI</h2>
                    ...
                    <Card>
                      <p className="text-[#7D7D7D] text-[11.16px]  font-normal leading-[13.51px] mb-[11px]"> Fees</p>
