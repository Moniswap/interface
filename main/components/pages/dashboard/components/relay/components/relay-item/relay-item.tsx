    ...
    <div data-aos="fade-up">
      ...
      >
        <div className="flex items-center gap-[19px]">
          ...
          <div>
            <div className="flex gap-2 items-center">
              <h2 className=" text-[13.1px] xl:text-base  font-medium leading-[19.36px] text-white">Moonwell veMONI</h2>
        ...
        <div className="xl:pt-0 mt-[19px] xl:mt-[0px] pt-[12px] w-full xl:w-auto ">
          <p className="text-[13px] xl:text-right  font-normal text-left leading-[15.73px] text-[#7D7D7D] ">APR</p>
        ...
        >
          Reward <span className="text-[13px]  text-[#CFCFCF] font-normal leading-[15.73px]">MONI</span>
        </Button>
      ...
      <div
        className={`w-[95%] transition-all duration-300 pb-[9px] xl:pb-0 overflow-hidden ${
          open ? "max-h-[187px] xl:max-h-[86px]" : "max-h-0"
        } m-auto rounded-b-xl bg-[#131212] `}
      >
        <div className="px-[14px] pr-[18px] rounded-xl pb-[12px] pt-[13px]  ">
          <div className="bg-[#1E1E1E] w-full flex flex-col xl:flex-row items-start xl:items-center rounded-xl justify-between px-[20px] pt-[22px] pb-[19px] ">
            <div className="flex flex-col xl:flex-row gap-y-[14px] xl:gap-y-0  gap-x-10">
              ...
              <p className="text-[15px]  text-[#7D7D7D] font-normal leading-[18.15px]">0.1 MONI locked for 4 years</p>
              <p className="text-[15px]  font-normal text-[#7D7D7D] leading-[18.15px]">0.0 MONI compounded</p>
            </div>
