...
export const Modal = ({ close, open, children, className, hideCloseButton }: Props) => (
  <Dialog open={open} onOpenChange={close}>
    <DialogContent className={cn("bg-black-10 rounded-[12px] max-w-[719px] !border-none pt-[37px]", className)}>
