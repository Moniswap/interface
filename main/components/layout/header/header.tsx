...
import { ConnectWallet, DisconnectModal, DropDown, Menu, MenuBar } from "./components";
...
export const Header = () => {
  ...
  return (
    <>
        ...
        <div className="w-full h-full px-5 lg:px-8 xl:px-0 container flex justify-between items-center border-b border-[#2B2B2B]">
          ...
          <div className="flex gap-x-40">
            ...
            <div className="flex items-center gap-[14px]">
              <IconButton className="hover:bg-orange-1" icon={<BearIcon className="w-[44px]" />} />
              {!isConnected ? (
                <Button
      ...
      <ConnectWallet open={connectWalletModal} setOpen={setConnectWalletModal} />
      <MenuBar open={menu} />
      <DisconnectModal open={openDisconnect} close={() => setOpenDisconnect(false)} />
    </>
  );
};
