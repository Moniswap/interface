  ...
  <footer className="w-full py-[67px] bg-black-6 border-t border-black-5 rounded-t-[100px]">
    <div className="container w-full flex h-full flex-col xl:flex-row px-5 lg:px-[69px] xl:px-[69px] ">
      <div className="hidden xl:block">
        <a href={"/"}>
          <Image src="/images/logo.png" width={150} height={60} alt="logo" className="flex" />
        </a>
        <h3 className="text-[20px] mt-[109px]  font-medium leading-[24px] text-white">AUDITED BY</h3>
        <Image src="/images/certik.png" width={200} height={70} alt="logo" className="object-cover mt-[9px]" />
      ...
      <div className="w-full xl:w-[40%]">
        <h3 className="text-[24px] font-medium  leading-6 text-white text-center">DON'T MISS THE GOOD NEWS</h3>
        ...
        <div className="justify-between mt-[50px] hidden xl:flex">
          <p className="text-[15px] w-1/2 font-medium  leading-[19px] text-white">Company</p>
          <p className="text-[15px] w-1/2 text-left font-medium  leading-[19px] text-white">Project & Developers</p>
        </div>
      ...
      <div className="w-[30%] hidden xl:flex justify-center flex-col items-center">
        ...
        <div className="flex gap-x-[9px]">
          {FOOTER_SOCIAL_MEDIA.map((item, index) => (
            <a href="/" key={index}>
              <IconButton className="hover:bg-orange-1 bg-[#000]" icon={<item.icon />} />
            </a>
          ))}
        </div>
      </div>
      ...
      <div className="w-full flex mt-[36px] flex-col items-center xl:hidden">
        ...
        <h3 className="text-[20px]  font-medium leading-[24px] text-white">AUDITED BY</h3>
        <Image src="/images/certik.png" width={200} height={70} alt="logo" className="object-cover mt-[9px]" />

        <p className="text-[15px] mt-[35px] font-medium  leading-[19px] text-white">Company</p>
        <a
          href="/"
        ...
        <p className="text-[15px]  mt-[53px] font-medium  leading-[19px] text-white">Project & Developers</p>
        <a
          href="/"
      ...
      <div className="w-full flex xl:hidden justify-center flex-col items-center">
        ...
        <div className="flex gap-x-[9px] mt-[70px]">
          {FOOTER_SOCIAL_MEDIA.map((item, index) => (
            <IconButton className="hover:bg-orange-1" icon={<item.icon />} key={index} />
          ))}
        </div>
