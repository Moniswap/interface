          ...
          <div className="flex flex-col justify-start items-center w-full gap-12 py-4">
            <div className="flex flex-col gap-6 justify-start items-center w-full">
              ...
              <div className="w-full join rounded-[12.8px] border border-[#2b2b2b]">
                <button className="btn btn-ghost join-item h-full flex justify-start items-center gap-3 md:w-1/3">
                  <Image src="/images/moni.png" height={30} width={30} alt="img" className="rounded-full" />
                  <span className="italic text-[#cfcfcf] font-[500] uppercase text-xs md:text-lg">moni</span>
            ...
            <div className="flex flex-col gap-6 justify-start items-center w-full">
              ...
              <div className="w-full join rounded-[12.8px] border border-[#2b2b2b]">
                <button className="btn btn-ghost join-item h-full flex justify-start items-center gap-3 md:w-1/3">
                  <Image src="/images/ethereum.png" height={30} width={30} alt="img" className="rounded-full" />
                  <span className="italic text-[#cfcfcf] font-[500] uppercase text-xs md:text-lg">eth</span>
                  <FiChevronDown size={20} color="#cfcfcf" />
                </button>
                <input
                  disabled
